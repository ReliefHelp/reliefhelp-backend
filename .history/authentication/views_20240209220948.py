...
class RegisterView(generics.GenericAPIView):
    """
    for creating a new user, you need email, password and username
    """
...
class VerifyEmail(views.APIView):
    """
    verifying the user by taking token that has been send to the  user as an email
    """
...
class LoginAPIView(generics.GenericAPIView):
    """
    Fields required are email and the password
